...
<head>
    ...
    <meta name="keywords" content="Miami Dade county FL Florida Employment, jobs, careers, hiring vacancies now" />
            ...
            <div id="content">
                ...
                <div id="content-right">
                    ...
                    <div style="width:100%;float:left;overflow:hidden;font-size:.8em;">
                        ...
                        <img src="img/hr-page.jpg" style="float:left;margin:0 15px" alt="Miami Dade county FL Florida Employment, jobs, careers, hiring vacancies now"><div style="padding: 10px 15px 10px 15px;"> <strong><label class="error">*</label> if you have already filled in the form below you can sign in using your email or phone
