                                ...
                                <div class="innerbox" style="margin-left: 10px;padding-top: 30px;">
                                    ...
                                    <form name="myForm" action="sendemployee.php" method="POST" enctype="multipart/form-data" id="employees_data_form">
                                        ...
                                        <div class="emp-content" style="width:650px;border:1px solid;padding: 15 0 0 15;">
                                            ...
                                            <div class="clear-float"></div>
											 <div class="col-250 left">
                                                <input onBlur="chk_gituname(this.value)" placeholder="GitHub Username *" class="emp-txtbox" type="text" name="git_uname" id="git_uname"></input><div><span style="display:none;color: #c72121; display: inline-block; position: relative;font-size: 9px;" id="git_uname_error">This field is required.</span><span id="er_chk_gitunm" style="color:#FF0000; display:none">Not a valid github username</span></div>
                                            </div>
                                            <div class="col-250 right">
