...
<div style="width:20%;float:left;text-align:right;padding-top:10px;"><img src="img/window-customize.gif" alt="Replacement Windows Gladwyne PA 19035" border="0" style="padding-bottom:2px;"></div>
<div style="width:80%;float:left;overflow:hidden;">
	<h1 style="padding: 12px 20px 0px 20px;font-size:1.1em;">
		Installing Quality Replacement Windows Gladwyne PA 19035 Right
	</h1>
...
<p style="padding: 0px 20px 10px 10px;font-size:.8em;" align="center"> 
				<a href="#" onclick="javascript:window.open('http://www.alside.com/alside_ds_1.html', 1000, 500)"><img src="img/logo-2.jpg" alt="Windows Replacement Tool Gladwyne PA 19035" border="0" title="Windows Replacement Tool" width="100px" height="100"></a>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="#" onclick="javascript:window.open('http://www.jmgroveconstruction.com/photogallery.php?page=windows', 1000, 500);" target="_blank"><img src="img/logo-1.jpg" alt="Windows Photo Gallery Gladwyne PA 19035" border="0" title="Windows Photo Gallery Gladwyne PA 19035" width="100px" height="100"></a>
	</p>
	
	<H2 style="padding: 10px 20px 10px 20px;font-size:1.0em;">
	Benefits of high performance, energy saving custom-made <strong>Replacement Windows Gladwyne PA 19035</strong>
	</h3>
	<p style="padding: 0px 20px 10px 20px;font-size:.8em;">
	<strong>Replacement Windows Gladwyne PA 19035</strong> in the United States are costing consumers approximately $35 billion a year in energy loss. The next generation of <strong>new replacement windows</strong> can cut energy loss in half. Many of today's high-performance <strong>replacement windows</strong> are three to four times more energy-efficient than <strong>windows</strong> commonly installed 10 years ago. <strong>Replacement Windows Gladwyne PA 19035</strong> comprise 10-25% of the exterior wall area of new homes. 
	According to recent studies <strong>Replacement Windows Gladwyne PA 19035</strong> account for up to 25% of a typical house's heating load  and account for up to 50% of a typical house's cooling load in cooling-dominated climates. Advances in technology such as increases in R-value, decreases in U-Value, Low-emittance (low-E) coatings, <strong>Double-glazed replacement windows</strong>, Argon  Gas filled <strong>replacement windows</strong> and welded <strong>replacement window</strong> frames have decreased energy bills by as much as 40%!
	</p>
	<p style="padding: 0px 20px 10px 20px;font-size:.8em;">
...
<div style="float:right;  padding: 0px 0px 0px 0px; width:23%; ">
 ...
 <img data-u="image" src="/inc/img/window-slider-image/product-1.jpg" alt="Replacement Windows Gladwyne PA 19035"/>
   ...
   <img data-u="image" src="/inc/img/window-slider-image/product-2.jpg" alt="Replacement Windows Gladwyne PA 19035" />
     ...
     <img data-u="image" src="/inc/img/window-slider-image/product-3.jpg" alt="Replacement Windows Gladwyne PA 19035" />
    ...
    <img data-u="image" src="/inc/img/window-slider-image/product-4.jpg" alt="Replacement Windows Gladwyne PA 19035" />
 ...
 <img data-u="image" src="/inc/img/window-slider-image/product-1.jpg" alt="Replacement Windows Gladwyne PA 19035" />
   ...
   <img data-u="image" src="/inc/img/window-slider-image/product-2.jpg"  alt="Replacement Windows Gladwyne PA 19035"/>
	...
	<p style="padding: 0px 20px 10px 20px;font-size:.8em;"><strong>Our Window Suppliers:</strong></p>
	<p style="padding: 0px 20px 10px 20px;font-size:.8em;" align="center">
		<a href="http://www.sunrisewindows.com/index.html" target="_blank"><img src="img/logo-sunrise.jpg" border="0" alt="Replacement Windows Gladwyne PA 19035"></a>	&nbsp;&nbsp;&nbsp; <a href="http://www.alside.com/index.aspx" target="_blank"><img src="img/logo-alside.jpg" border="0" alt="Replacement Windows Gladwyne PA 19035"></a>&nbsp;&nbsp;&nbsp; <a href="http://www.greatlakeswindow.com/homeowner/homeowners.html" target="_blank"><img src="img/logo-greatlakes.jpg" border="0" alt="Replacement Windows Gladwyne PA 19035"></a>
	</p>
	<H2 style="padding: 10px 20px 10px 20px;font-size:1.0em;">
	Why <strong>Custom Vinly Why Custom Vinly Replacement Windows Gladwyne PA 19035</strong> From J.M. Grove are the <strong>Best Windows</strong>
	</h3>
	<p style="padding: 0px 20px 10px 20px;font-size:.8em;">
	<strong>Vinyl Replacement Windows Gladwyne PA 19035</strong> lower utility bills. High-performance <strong>replacement windows</strong> are better insulated and more air-tight. These features reduce energy consumption for heating and cooling which results in lower utility bills, making a <strong>windows home</strong> less expensive to operate. In insulated vinyl frames, the hollow cavities of the frame are filled with insulation making them thermally superior to standard vinyl and wood frames.
	</p>
	<p style="padding: 0px 20px 10px 20px;font-size:.8em;">
	<img src="../img/ladywindow.gif" alt="Replacement Windows Gladwyne PA 19035" width="165" height="134" border="0" align="left"><strong>Vinyl replacement windows</strong> are high quality. High-performance <strong>windows</strong> are often constructed with better quality materials that can result in stronger, easier to operate, and longer lasting <strong>windows</strong>.  As a result of these manufacturers frequently offer extended warranties improvements on these products. <strong>Vinyl window</strong> frames do not require painting and have good moisture resistance. Because the color goes all the way through, there is no finish coat that can be damaged or deteriorate over time -- the surface is therefore maintenance-free.
	</p>
	<p style="padding: 0px 20px 10px 20px;font-size:.8em;">
	...
	<p style="padding: 0px 20px 10px 20px;font-size:.8em;">
	<img src="../img/airinfiltration.gif" alt="Replacement Windows Gladwyne PA 19035" width="323" height="218" border="0"align="right">Reduced obsolescence.  Based on recent trends for improved efficiency, high-performance <strong>replacement windows</strong> are expected to become standard practice for the building industry. Since it is both difficult and costly to <strong>replace windows</strong> after a house is built, it is best to install high-performance products during the original construction. ENERGY STAR labeled homes constructed with high-performance <strong>Replacement Windows Gladwyne PA 19035</strong> are, therefore, expected to be less vulnerable to obsolescence. 
	</p>
	<p style="padding: 0px 20px 10px 20px;font-size:.8em;">
		Improved comfort. High-performance <strong> Replacement Windows Gladwyne PA 19035</strong> reduce conductive heat losses and gains resulting in warmer interior surfaces during the winter and cooler interior surfaces during the summer. In <strong>home windows</strong>, approximately 40 percent of our physical comfort is due to the radiant heat exchange between our bodies and the surrounding interior surfaces. Thus, high-performance <strong>Replacement Windows Gladwyne PA 19035</strong> improve comfort by reducing this radiant heat exchange. In addition, improved frames reduce drafts and provide more consistent temperatures throughout the house.</li> 
...
<br>
	...
	<img src="../img/rvalue.gif" alt="Replacement Windows Gladwyne PA 19035" width="323" height="218" border="0"align="left">
...
<div class="option">
						...
						<div class="option-glass" style="width:150px;"><a href="http://jmgroveconstruction.com/doors-Gladwyne-Pa-19035.php" style="color:#333;"><img src="img/doors.jpg" alt="Doors and Windows"><br><strong>Doors Bala Gladwyne PA 19035</strong></a></div>
...
<div class="option-glass" style="width:150px;"><a href="http://jmgroveconstruction.com/bathroom-remodeling-Gladwyne-Pa-19035.php" style="color:#333;"><img src="img/bathroom-icon.png" alt="bathroom remodeling company" width="125" height="135" border="0"><br><strong>Bathroom Remodeling Gladwyne PA-19035</strong></a></div>
...
<div style="width:24%; float:left;padding: 15px 15px15px 0px;"><img src="/inc/img/product3.jpg" height='150px'; width='150px'; alt="Windows Replacement Tool Gladwyne PA 19035"/></div>
