...
<head>
    ...
    <title>Jobs - Recruitment - Job Search - Employment - Job Vacancies - J.M. Grove Construction  Rio De Janiero Brazil</title>
    <link rel="stylesheet" href="./inc/grovestyle.css" type="text/css">
    <link rel="stylesheet" href="./inc/intlTelInput.css" type="text/css">
    <meta name="description" content="J.M.Grove -  Now Hiring in Rio De Janiero Brazil for job vacancies on jmgroveconstruction.com for full time and part time for for different position in IT and admin roles" />
    <meta name="keywords" content="Now Hiring in Rio De Janiero Brazil  Employment, jobs, careers, hiring vacancies now" />
    ...
    <div align="center">
        <div id="shell">
            ...
            <div id="content">
				...
				<div style="width:20%;float:left;text-align:right;padding-top:10px;"><img src="img/hr-page.png" border="0" style="padding-bottom:2px;" alt="Employment, jobs, careers, hiring vacancies now Rio De Janiero Brazil " title="Employment, jobs, careers, hiring vacancies now Rio De Janiero Brazil"></div>
