...
<div style="width:100%;float:left;overflow:hidden;">
	...
	<input type="hidden" name="page" value="<?php echo $_GET['page'];?>">
		...
		<p align="right"><input type="button" value="" onClick="validate_form();" style="background: url(img/button-service.jpg) repeat scroll 0 0 rgba(0, 0, 0, 0); height:33px; width:200px; border:0px; z-index: 2000; cursor: pointer;"></p>
	
		<?php } else if($page == "quote"){ ?>
		
		<p align="right"><input type="button" value="" onClick="validate_form();" style="background: url(img/button-estimate.jpg) repeat scroll 0 0 rgba(0, 0, 0, 0); height:45px; width:200px; border:0px; z-index: 2000; cursor: pointer;"></p>
