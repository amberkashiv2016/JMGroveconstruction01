...
<div class="option">
	<p align="right" style="padding-right:15px;"><a href="skylights.php?type=<?php echo("$val0");?>&option=<?php echo("$val");?>&control=null"><img src="img/button-continue.jpg" alt="skylights"></a></p>
</div>
<div class="option">
	<div class="option-image"><a href="skylights.php?type=<?php echo("$val0");?>&option=<?php echo("$val");?>&control=null"><img src="img/skylights-ventalation.jpg" alt="skylights"></a></div>
...
<div class="option">
	<div class="option-image"><a href="skylights.php?type=<?php echo("$val0");?>&option=<?php echo("$val");?>&control=null"><img src="img/skylights-lightaddon.jpg" alt=skylights"></a></div>
	<div class="option-text">
...
<div class="option">
	<div class="option-image"><a href="skylights.php?type=<?php echo("$val0");?>&option=<?php echo("$val");?>&control=null"><img src="img/skylights-dimmer.jpg" alt="skylights"></a></div>
	<div class="option-text">
...
<div style="width:100%;float:left;overflow:hidden;">
	...
	<?php if ($val0 == "manual") {?>
	<div class="option">
			<div class="option-glass"><a href="skylights.php?type=<?php echo("$val0");?>&option=<?php echo("$val");?>&control=crankhandle"><img src="img/skylights-crank.jpg" alt="skylights"></a><br><strong>Crank Handle</strong></div>
			<div class="option-glass"><a href="skylights.php?type=<?php echo("$val0");?>&option=<?php echo("$val");?>&control=polecrank"><img src="img/skylights-polecrank.jpg" alt="skylights"></a><br><strong>Pole Crank</strong></div>
	</div>
	<?php } ?>
