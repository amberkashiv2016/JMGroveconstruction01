...
<p style="padding: 0px 20px 10px 10px;font-size:.8em;" align="center"> 
	...
	<p style="padding: 0px 20px 10px 20px;font-size:.8em;" align="center">
        ...
        <div data-u="loading" style="position: absolute; top: 0px; left: 0px;">
            ...
            <div style="position:absolute;display:block;background:url('inc/img/loading.gif') no-repeat center center;top:0px;left:0px;width:100%;height:100%;"></div>
        </div>
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 809px; height: 150px; overflow: hidden;">
            <div style="display: none;">
                <img data-u="image" src="inc/img/005.jpg" />
            </div>
            <div style="display: none;">
                <img data-u="image" src="inc/img/006.jpg" />
            </div>
            <div style="display: none;">
                <img data-u="image" src="inc/img/011.jpg" />
            </div>
            <div style="display: none;">
                <img data-u="image" src="inc/img/013.jpg" />
            </div>
            <div style="display: none;">
                <img data-u="image" src="inc/img/014.jpg" />
            </div>
            <div style="display: none;">
                <img data-u="image" src="inc/img/019.jpg" />
            </div>
            <div style="display: none;">
                <img data-u="image" src="inc/img/020.jpg" />
            </div>
            <div style="display: none;">
                <img data-u="image" src="inc/img/021.jpg" />
            </div>
           <!--- <div style="display: none;">
        ...
        <!-- Bullet Navigator
        <div data-u="navigator" class="jssorb03" style="bottom:10px;right:10px; width:50%;">
            bullet navigator item prototype
            <div data-u="prototype" style="width:10px;height:10px; margin: 0 auto; right-padding="50%;>
            <div data-u="prototype" style="width:10px;height:10px; margin: 0 auto; right-padding="50%;>
