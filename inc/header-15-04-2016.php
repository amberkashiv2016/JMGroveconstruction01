...
<div id="header">
	...
	<div id="header-mid">
		<div style="float:left;width:42%">
			<div>
						<a href="/index.php"><img src="/img/george-j-grove-replacement-windows_cam.jpg" border="0" alt="J. M. Grove Replacement Windows"></a>
						<a href="/index.php" style="position:relative;top:-28px;left:131px;color:#000000;text-decoration:none;font-weight:900;font-size:18px;font-family:Times New Roman, Times, serif;"><b>CONSTRUCTION</b></a>
	...
	<div id="splash-left" style="height:144px;">
		...
		<div align="left" style="float:left;width:100%;height:124px;overflow:hidden;">
			<p align="left" style="padding: 5px 0 0 15px;">
				...
				<?php if ($currentpage == "industry") {?><img src="/img/industrylinks.gif" alt="industry links"><?php }?>
