...
<head>
    ...
    <title>Asp dot net Jobs - Recruitment - Job Search - Employment - Job Vacancies - J.M. Grove Construction  </title>
    <link rel="stylesheet" href="./inc/grovestyle.css" type="text/css">
    <link rel="stylesheet" href="./inc/intlTelInput.css" type="text/css">
    <meta name="description" content="J.M.Grove -  Now Hiring for Asp dot net for job vacancies on jmgroveconstruction.com for full time and part time for for different position in IT and admin roles" />
    <meta name="keywords" content="Now Hiring for Asp dot net  Employment, jobs, careers, hiring vacancies now" />
    ...
    <div align="center">
        <div id="shell">
            ...
            <div id="content">
				...
				<div style="width:20%;float:left;text-align:right;padding-top:10px;"><img src="img/hr-page.png" border="0" style="padding-bottom:2px;" alt=" Asp dot net Employment, jobs, careers, hiring vacancies now " title=" Asp dot net Employment, jobs, careers, hiring vacancies now"></div>
				<div style="width:80%;float:left;overflow:hidden;">
					<h2 style="padding: 12px 20px 0px 20px;font-size:1.1em;">
						Asp dot net Employment, Jobs, Careers Hiring Now! 
					</h2>
