...
<?php $currentpage = "BathroomLighting"; ?>
<html>
<head>
...
<div class="option">
	...
	<div class="option-text">
		...
		<form method="post" class="bathroom-tile-flooring-dropdown-class" action="bathroom-lighting-backend.php">
			...
			<div class="bathroom-tile-flooring-dropdown">
			 	<select class="" name="bathroom-tile-flooring-value">
				  	<option value="Bath Fans-Fan only">Fan only</option>
				  	<option value="Bath Fans-Fan with light">Fan with light</option>
				  	<option value="Bath Fans-Fan with heater">Fan with heater</option>
				  	<option value="Bath Fans-Decorative">Decorative</option>
				  	<option value="Bath Fans-Heater and light">Heater and light</option>
				  	<option value="Bath Fans-Ultra silent">Ultra silent</option>
				</select> 
			</div>
		</form>
	</div>
