...
<head>
	...
	<link rel="stylesheet" href="inc/grovestyle.css" type="text/css"><meta name="description" content="J. M. Grove - The experts in home improvement services - including replacement windows, doors, roofing, vinyl siding, gutters, awnings, stone veneer, skylights, additions, decks and much more! ."/>
	<meta name="keywords" content=" J. M. Grove, home improvement, contractor, replacement windows, doors, roofing, vinyl siding, gutters, awnings, brick, stone veneer, skylights, additions, decks, "/>
		...
		<div id="header">
			...
			<div id="header-mid">
				<div style="float:left;width:65%">
					<p style="padding: 20px 0px 0px 12px;"><a href="index.html"><img src="/img/george-j-grove-replacement-windows.jpg" border="0" alt="J. M. Grove Replacement Windows"></a></p>
				</div>
				<div style="float:left;width:35%;height:124px;background: url(img/header-vdiv.jpg) no-repeat;">
					...
					<p style="padding: 0px 0px 0px 22px;font-size:.8em;">547 W Franklin Rd, Glassboro Nj, 08028</p>
