...
<p style="padding: 0px 15px 10px 15px;" align="center">
  ...
  <div class="leftdiv" style="width:250px;padding-left:10px;margin-left:20px;margin-top:20px;float:left;">
    ...
    <textarea rows="4" placeholder="Address *" name="address" id="address" style="margin:5px;color:#999999;width:230px;height:25px;border:1px solid;border-radius:5px;height:65px;" 
     name="address"></textarea>
    <input placeholder="Salary Requirements *"  name="salary" id="salary" style="margin:5px;color:#999999;width:230px;height:25px;border:1px solid;border-radius:5px;" 
