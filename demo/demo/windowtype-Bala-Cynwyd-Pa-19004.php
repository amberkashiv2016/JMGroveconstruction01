...
<div style="width:20%;float:left;text-align:right;padding-top:10px;"><img src="img/window-customize.gif" alt="Replacement Windows Bala Cynwyd PA 19004" border="0" style="padding-bottom:2px;"></div>
<div style="width:80%;float:left;overflow:hidden;">
	<h1 style="padding: 12px 20px 0px 20px;font-size:1.1em;">
		Installing Quality Replacement Windows Bala Cynwyd PA 19004 Right
	</h1>
...
<p style="padding: 0px 20px 10px 10px;font-size:.8em;" align="center"> 
	...
	Benefits of high performance, energy saving custom-made <strong>Replacement Windows Bala Cynwyd PA 19004</strong>
	</h3>
	<p style="padding: 0px 20px 10px 20px;font-size:.8em;">
	<strong>Replacement Windows Bala Cynwyd PA 19004</strong> in the United States are costing consumers approximately $35 billion a year in energy loss. The next generation of <strong>new replacement windows</strong> can cut energy loss in half. Many of today's high-performance <strong>replacement windows</strong> are three to four times more energy-efficient than <strong>windows</strong> commonly installed 10 years ago. <strong>Replacement Windows Bala Cynwyd PA 19004</strong> comprise 10-25% of the exterior wall area of new homes. 
	According to recent studies <strong>Replacement Windows Bala Cynwyd PA 19004</strong> account for up to 25% of a typical house's heating load  and account for up to 50% of a typical house's cooling load in cooling-dominated climates. Advances in technology such as increases in R-value, decreases in U-Value, Low-emittance (low-E) coatings, <strong>Double-glazed replacement windows</strong>, Argon  Gas filled <strong>replacement windows</strong> and welded <strong>replacement window</strong> frames have decreased energy bills by as much as 40%!
	</p>
	<p style="padding: 0px 20px 10px 20px;font-size:.8em;">
	...
	<p style="padding: 0px 20px 10px 20px;font-size:.8em;">
	<img src="../img/airinfiltration.gif" alt="Replacement Windows Bala Cynwyd PA 19004" width="323" height="218" border="0"align="right">Reduced obsolescence.  Based on recent trends for improved efficiency, high-performance <strong>replacement windows</strong> are expected to become standard practice for the building industry. Since it is both difficult and costly to <strong>replace windows</strong> after a house is built, it is best to install high-performance products during the original construction. ENERGY STAR labeled homes constructed with high-performance <strong>Replacement Windows Bala Cynwyd PA 19004</strong> are, therefore, expected to be less vulnerable to obsolescence. 
	</p>
	<p style="padding: 0px 20px 10px 20px;font-size:.8em;">
		Improved comfort. High-performance <strong> Replacement Windows Bala Cynwyd PA 19004</strong> reduce conductive heat losses and gains resulting in warmer interior surfaces during the winter and cooler interior surfaces during the summer. In <strong>home windows</strong>, approximately 40 percent of our physical comfort is due to the radiant heat exchange between our bodies and the surrounding interior surfaces. Thus, high-performance <strong>Replacement Windows Bala Cynwyd PA 19004</strong> improve comfort by reducing this radiant heat exchange. In addition, improved frames reduce drafts and provide more consistent temperatures throughout the house.</li> 
...
<br>
	...
	<img src="../img/rvalue.gif" alt="Replacement Windows Bala Cynwyd PA 19004" width="323" height="218" border="0"align="left">
...
<p style="padding: 0px 20px 10px 20px;font-size:.8em;">
<div class="option">
						<div class="option-glass" style="width:150px;"><a href="http://jmgroveconstruction.com/replacement-windows-Bala-Cynwyd-Pa-19004.php" style="color:#333;"><img src="img/window-double-hung.gif" alt="Replacement Windows"><br><strong>Replacement Windows Bala Cynwyd PA-19004</strong></a></div>
						...
						<div class="option-glass" style="width:150px;"><a href="http://jmgroveconstruction.com/vinyl-siding-BalaCynwyd-Pa-19004.php" style="color:#333;"><img src="img/siding-dutch-clap.jpg" alt="vinyl Siding"><br><strong>Vinyl Siding Bala Cynwyd PA-19004</strong></a></div>
