                    ...
                    <div style="width:100%;float:left;overflow:hidden;font-size:.8em;">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <input name="txtloginid" id="txtloginid" tabindex="1" placeholder="Enter email address or phone number" style="width:312px;" type="text">
                                                        ...
                                                        <tr>
                                                            <td style="padding-bottom:2px !important;background:none !important;">
                                                                <label></label>
                                                                <div class="btn_sec">
                                                                    <input name="btnsubmit" value="Login" onclick="" id="btnsubmit" tabindex="3" style="width: 98% !important; height: 67% !important;" type="submit">
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                        ...
                        <div style="padding: 0px 15px 10px 15px;">
                            <div id="formbox" style="display:<?php echo $style;+';'?>margin-left:20px;">
                                <div class="innerbox" style="margin-left: 10px;">
                                    <h2 class="boxheading" align="center">Employment Application</h2>
                                    <form name="myForm" action="sendemployee.php" method="POST" enctype="multipart/form-data" onSubmit="return formValidation()">
                                        <div class="emp-content" style="width:650px;border:1px solid;padding: 15 0 0 15;">
                                            <div class="col-250 left">
                                                ...
                                                <select name="position" id="position" class="emp-ddl" onchange="myFunction(this.value)">
                                                    <?php
                                            ...
                                            <div class="col-250 right">
                                                <input placeholder="State*" id="state" class="emp-ddl" type="text" name="state">
                                                </input>
                                            </div>
                                            <div class="clear-float"></div>
                                            <div class="col-250 left">
                                            ...
                                            <div class="clear-float"></div>
                                            <div class="col-250 left">
                                                <input placeholder="Email *" style="margin:12px 0;color:#999;width:94%;height:25px;border:1px solid;border-radius:5px;" type="text" name="email" id="email">
                                                </input>
                                                <div style="margin-top: 10px;display:none;" class="ExtAddEmailTemplate" id="ExtAddEmailTemplate">
                                            ...
                                            <div class="col-250 right">
                                                <input placeholder="Phone *" style="color:#999;margin: 12px 0; width:94%;height:25px;border:1px solid;border-radius:5px;"
                                            ...
                                            <div class="col-250 right">
                                                ...
                                                <input placeholder="(in $USD/Year)" class="emp-txtbox" type="number" name="salaryrequirements" id="salaryrequirements">
                                                </input>
                                            </div>
                                            <div class="clear-float"></div>
