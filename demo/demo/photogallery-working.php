		...
		<div id="content">
			...
			<div id="content-right">
				...
				<div style="width:100%;float:left;overflow:hidden;font-size:.8em;">
					...
					<?php if ($section!="bathroom") {?><a href="photogallery.php?page=bathroom&image=Flooring1.jpg" style="color:#c72121;">Bathroom</a> | <?php } ?>
					...
					<p style="padding: 10px 15px 10px 15px;" align="center">						
						...
						<?php }
						 elseif ($section=="bathroom") { ?>
							<?php if (($img)) { ?>
								<img src="/img/<?php echo($img); ?>" style="width:600px;height:251px;">
							<?php }  ?>
						<?php } ?>
