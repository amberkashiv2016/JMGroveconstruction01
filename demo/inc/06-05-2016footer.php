<div id="footer">
	<div id="footer-top">
		...
		<div style="float:left;"><img src="/img/footer-vdiv.jpg"></div>
		<div style="float:left;padding: 15px 18px 0px 18px;font-size:.8em;"><a href="employment.php" style="text-decoration:none;">Employment</a></div>
		<div style="float:left;"><img src="/img/footer-vdiv.jpg"></div>
...
<?php /*?><div style="float:left;"><img src="/img/footer-vdiv.jpg"></div>
