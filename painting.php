...
<div class="option">
	...
	<div class="option-text">
		...
		<form method="post" class="bathroom-tile-flooring-dropdown-class" action="painting-backend.php">
			...
			<div class="bathroom-tile-flooring-dropdown">
			 	<select class="" name="bathroom-tile-flooring-value">
				  	<option value="Paint type-Flat">Flat</option>
				  	<option value="Paint type-Gloss">Gloss</option>
				  	<option value="Paint type-Semi-gloss">Semi-gloss</option>
				  	<option value="Paint type-Satin">Satin</option>
				  	<option value="Paint type-Eggshell">Eggshell</option>
				</select> 
			</div>
		</form>
	</div>
